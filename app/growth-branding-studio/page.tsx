...
export default async function GrowthBrandingStudioPage() {
  ...
  const bannerTitle = fields?.studioBanner?.bannerTitle || "Growth &\nBranding Studio";
  const bannerDescription = fields?.studioBanner?.bannerDescription || "Growth & Branding That Inspire and Perform";
  ...
  return (
    <main className="min-h-screen">
      <DigitalExperienceBanner
        ...
        videoSrc={bannerVideoUrl ? resolveImageUrl(bannerVideoUrl) : "/videos/animated_clip_3.mp4"}
        backgroundImage={{

...
export default async function ApplicationDevelopmentStudioPage() {
  ...
  const bannerTitle = fields?.studioBanner?.bannerTitle || "Application\nDevelopment Studio";
  ...
  return (
    <main className="min-h-screen">
      <DigitalExperienceBanner
        ...
        videoSrc={bannerVideoUrl ? resolveImageUrl(bannerVideoUrl) : "/videos/animated_clip_2.mp4"}
        backgroundImage={{

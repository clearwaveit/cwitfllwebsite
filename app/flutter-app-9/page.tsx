...
import flutterAppImg9 from "@/app/assets/imgs/flutter_app_9.png";
...
export default function FlutterAppPage9() {
  ...
  const title = (<>Empowering Energy Sector with Digital Solutions</>);
  ...
  return (
    <main className="min-h-screen relative">
      ...
      <HeroBanner
        title="Digital Solutions for Energy"

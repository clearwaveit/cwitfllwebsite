...
import flutterAppImg6 from "@/app/assets/imgs/flutter_app_6.png";
...
export default function FlutterAppPage6() {
  ...
  const title = (<>Empowering Industry with Digital Solutions</>);
  ...
  return (
    <main className="min-h-screen relative">
      ...
      <HeroBanner
        title="Digital Solutions for the Industrial Sector"

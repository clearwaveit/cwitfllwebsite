...
import flutterAppImg7 from "@/app/assets/imgs/flutter_app_7.png";
...
export default function FlutterAppPage7() {
  ...
  const title = (<>Digital Solutions for FMCG Success</>);

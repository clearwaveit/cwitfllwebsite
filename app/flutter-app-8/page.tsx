...
import flutterAppImg8 from "@/app/assets/imgs/flutter_app_8.png";
...
export default function FlutterAppPage8() {
  ...
  const title = (<>Leading the Way in Digital Solutions for Technology</>);

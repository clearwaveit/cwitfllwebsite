...
export default function Blogs() {
  return (
    <section className="relative min-h-screen bg-black md:py-50 py-0 overflow-hidden">
      <div className="relative z-10 mx-auto px-3 md:px-0 lg:px-0 global-section-padding blogs-section-content-container">
        <h2 className="text-[30px] md:text-[50px] font-light text-white leading-[60px] md:leading-[80px] mb-10">
          Latest Blogs and Insights
        </h2>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-6 blogs-cards-grid">
          {blogs.map((blog, index) => (
            <div key={index} className="relativeflex flex-col w-auto md:w-[453.34px] h-[384.98px] md:h-[484.98px] blogs-section blogs-card">
              ...
              <div className="bg-white w-auto md:w-[453.34px] h-[180.39px] md:h-[231.39px] flex flex-col justify-center blogs-section-image blogs-card-content">
